...
$(function () {
  var html = $('html, body'),
      ...
      navDropdownToggle = $('.has-dropdown'); // Nav toggle
...
$(window).on('load', function () {
  ...
  $(function () {
    debounce_render();
    var url = window.location.href; // $('.menu-item  a').parent().removeClass('active');
...
window.onload = function () {
  ...
  $('.deal-countdown').each(function () {
    ...
    var thisDealTime = $(this).attr('data-deal-time');
    /*lay moc thoi gian*/
...
var _owl = _interopRequireDefault(require("owl.carousel2"));
...
},{"owl.carousel2":1}],14:[function(require,module,exports){
