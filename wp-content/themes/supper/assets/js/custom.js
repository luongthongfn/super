! function o(r, a, h) {
    ...
    1: [function (t, e, i) {
        var s, n, o, a, r, h, l, c, d, p, u, g, m, f, v, _, y;
        ! function (h, i, n, o) {
            function l(t, e) {
            ...
            l.Defaults = {
                ...
                run: function () {
                    ...
                    for (o /= 2; o--;) t.push(this.normalize(t.length / 2, !0)), h(e[t[t.length - 1]][0]).clone(!0).addClass("cloned").appendTo(this.$stage), t.push(this.normalize(e.length - 1 - (t.length - 1) / 2, !0)), h(e[t[t.length - 1]][0]).clone(!0).addClass("cloned").prependTo(this.$stage);
                    this._clones = t
                }
            }, {
                filter: ["width", "items", "settings"],
                ...
                this._interval || (this._visible = this._core.$element.is(":visible"), this._interval = n.setInterval(s.proxy(this.refresh, this), this._core.settings.autoRefreshInterval))
            ...
            }, s.fn.owlCarousel.Constructor.Plugins.AutoRefresh = o, a = window.Zepto || window.jQuery, r = window, document, (h = function (t) {
                ...
                }, this._core.options = a.extend({}, h.Defaults, this._core.options), this._core.$element.on(this._handlers)
            }).Defaults = {
                lazyLoad: !1
                ...
                !i || -1 < a.inArray(e.get(0), this._loaded) || (i.each(a.proxy(function (t, e) {
                    var i, s = a(e),
                        n = 1 < r.devicePixelRatio && s.attr("data-src-retina") || s.attr("data-src");
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, a.fn.owlCarousel.Constructor.Plugins.Lazy = h, l = window.Zepto || window.jQuery, window, document, (c = function (t) {
                ...
                }, this._core.options = l.extend({}, c.Defaults, this._core.options), this._core.$element.on(this._handlers)
            }).Defaults = {
                autoHeight: !1,
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, l.fn.owlCarousel.Constructor.Plugins.AutoHeight = c, d = window.Zepto || window.jQuery, window, p = document, (u = function (t) {
                ...
                }, this._core.options = d.extend({}, u.Defaults, this._core.options), this._core.$element.on(this._handlers), this._core.$element.on("click.owl.video", ".owl-video-play-icon", d.proxy(function (t) {
                    this.play(t)
                }, this))
            }).Defaults = {
                video: !1,
            ...
            }, u.prototype.thumbnail = function (e, t) {
                var i, s, n = t.width && t.height ? 'style="width:' + t.width + "px;height:" + t.height + 'px;"' : "",
                    ...
                    l = function (t) {
                        i = h.lazyLoad ? '<div class="owl-video-tn ' + a + '" ' + r + '="' + t + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>', e.after(i), e.after('<div class="owl-video-play-icon"></div>')
                    };
                ...
                "youtube" === t.type ? (s = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg", l(s)) : "vimeo" === t.type ? d.ajax({
                    type: "GET",
            ...
            }, u.prototype.isInFullScreen = function () {
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, d.fn.owlCarousel.Constructor.Plugins.Video = u, g = window.Zepto || window.jQuery, window, document, (m = function (t) {
                this.core = t, this.core.options = g.extend({}, m.Defaults, this.core.options), this.swapping = !0, this.previous = void 0, this.next = void 0, this.handlers = {
                    "change.owl.carousel": g.proxy(function (t) {
                        t.namespace && "position" == t.property.name && (this.previous = this.core.current(), this.next = t.property.value)
                    }, this),
                    "drag.owl.carousel dragged.owl.carousel translated.owl.carousel": g.proxy(function (t) {
                        t.namespace && (this.swapping = "translated" == t.type)
                    }, this),
                    "translate.owl.carousel": g.proxy(function (t) {
                ...
                if (1 === this.core.settings.items && g.support.animation && g.support.transition) {
                    this.core.speed(0);
                    var t, e = g.proxy(this.clear, this),
                        i = this.core.$stage.children().eq(this.previous),
                        s = this.core.$stage.children().eq(this.next),
                        n = this.core.settings.animateIn,
                        o = this.core.settings.animateOut;
                    this.core.current() !== this.previous && (o && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), i.one(g.support.animation.end, e).css({
                        left: t + "px"
                    }).addClass("animated owl-animated-out").addClass(o)), n && s.one(g.support.animation.end, e).addClass("animated owl-animated-in").addClass(n))
                }
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, g.fn.owlCarousel.Constructor.Plugins.Animate = m, f = window.Zepto || window.jQuery, v = window, _ = document, (y = function (t) {
                ...
                }, this._core.$element.on(this._handlers), this._core.options = f.extend({}, y.Defaults, this._core.options)
            }).Defaults = {
                autoplay: !1,
                autoplayTimeout: 5e3,
                autoplayHoverPause: !1,
                autoplaySpeed: !1
            }, y.prototype.play = function (t, e) {
                this._paused = !1, this._core.is("rotating") || (this._core.enter("rotating"), this._setAutoPlayInterval())
            }, y.prototype._getNextTimeout = function (t, e) {
                return this._timeout && v.clearTimeout(this._timeout), v.setTimeout(f.proxy(function () {
                    this._paused || this._core.is("busy") || this._core.is("interacting") || _.hidden || this._core.next(e || this._core.settings.autoplaySpeed)
                }, this), t || this._core.settings.autoplayTimeout)
            }, y.prototype._setAutoPlayInterval = function () {
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, f.fn.owlCarousel.Constructor.Plugins.autoplay = y,
            function (o, t, e, i) {
                "use strict";
                var s = function (t) {
    ...
    2: [function (t, e, i) {
        ...
        $(window).on("load", function () {
            ...
            }), $("a.go-to[href^='#']").click(function (t) {
                t.preventDefault(), $("#menu").removeClass("is-active");
                var e = $($(this).attr("href"));
                if (e.length) {
                    var i = $(".fixed").height() || 0,
                        s = e.offset().top - i;
                    $("html, body").animate({
                        scrollTop: s
                    }, "slow")
    ...
    3: [function (t, e, i) {
        "use strict";
        $(function () {
            $("input[type='number'][maxlength]").on("keyup keydown keypress blur change input", function (t) {
                return 8 === t.keyCode || 9 === t.keyCode || this.value.length < +this.attributes.maxlength.value
            })
        })
    }, {}],
    4: [function (t, e, i) {
        ...
        $(function () {
            $(".js-tab").each(function () {
                var i = $(this).find(".js-tabnav"),
                    t = "ontouchstart" in document.documentElement ? "touchstart" : "click";
                $(i).on(t, "a[href^='#']", function (t) {
                    if (t.preventDefault(), !$(this).parent().hasClass("active")) {
                        $(i).find(".active").removeClass("active"), $(this).parent().addClass("active");
                        var e = $($(this).attr("href"));
                        e.siblings().removeClass("in"), setTimeout(function () {
                            e.siblings().removeClass("active")
                        }, 100), e.addClass("active"), setTimeout(function () {
                            e.addClass("in")
                        }, 100)
                    }
                })
    ...
    5: [function (t, e, i) {
        ...
        $(function () {
            ...
            t.on("click", function (t) {
                var e = $(this);
                t.preventDefault(), e.toggleClass("is-active"), s.toggleClass("is-visible"), i.toggleClass("nav-open")
            }), e.on("click", function () {
            ...
            $(".drop-button, .dropdown-content .close").click(function (t) {
                t.preventDefault(), $(this).parents(".search-drop").find(".dropdown-content").toggleClass("visible")
            }), $(document).click(function (t) {
                $(t.target).closest(".search-drop").length || $(".dropdown-content").removeClass("visible")
            })
        }), $(function () {
            if ($(".dropdown").click(function (t) {
                    $(this).toggleClass("is-active")
                }), $(".dropdown.nested").on("click", "*", function (t) {
                    t.stopPropagation()
                }), $(".sticky-header").length) {
                var t = $(".sticky-header");
                t.after("<div class='after-fixed'></div>");
                var e = t.offset().top;
                $(".after-fixed").css("padding-top", $(".fixed").height()), $(window).scroll(function () {
                    992 < window.innerWidth && $(window).scrollTop() >= e ? (t.addClass("fixed"), $(".after-fixed").css("padding-top", $(".fixed").height())) : (t.removeClass("fixed"), $(".after-fixed").css("padding-top", "0px"))
                })
            }
        }), $(function () {
            $(document).ready(function (t) {
                $(".search-panel .dropdown-select").find("a").click(function (t) {
                    t.preventDefault();
                    var e = $(this).attr("href").replace("#", ""),
                        i = $(this).text();
                    $(".search-panel span#search_concept-top").text(i), $(".input-group #search_param").val(e)
                })
            }), $(document).ready(function (t) {
                $(".search-panel .dropdown-menu").find("a").click(function (t) {
                    t.preventDefault();
                    var e = $(this).attr("href").replace("#", ""),
                        i = $(this).text();
                    $(".search-panel span#search_concept").text(i), $(".input-group #search_param").val(e)
                })
            })
        })
    }, {}],
    ...
    7: [function (t, e, i) {
        ...
        $(function () {
            if ($(".sticky-header").length) {
                $(".sticky-header");
                var t = $(".js-after-fixed");
                t && t.css("padding-top", $(".fixed").height())
            }
        })
    }, {}],
    8: [function (t, e, i) {
    ...
    9: [function (t, e, i) {
        ...
        $(window).on("load", function () {
            function t() {
                $(".imgRow").length && ($(".reRenderImg img").css("height", "auto"), $(".imgRow").each(function () {
                    var t, e, i;
                    e = (t = $(this).find(".reRenderImg img")).width(), i = t.height() / e, t.height(Math.ceil(i * parseInt(e)))
                }))
            }
            var e;
            ...
            $(function () {
                ...
                $('.menu-item  a[href="' + t + '"]').parent().addClass("active")
            ...
            $(".deal-countdown").each(function () {
                ...
                var r = $(this),
                    ...
                    h = setInterval(function () {
                        ...
                        r.find(".day").find(".num").find("span").text(i), r.find(".hour").find(".num").find("span").text(s), r.find(".min").find(".num").find("span").text(n), r.find(".sec").find(".num").find("span").text(o), e < 0 && clearInterval(h)
                    }, 1e3);
    ...
    12: [function (t, e, i) {
        "use strict";
        var s;
        (s = t("owl.carousel2")) && s.__esModule;
        $(function () {
