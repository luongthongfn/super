...
gulp.task('script', () => {
  ...
  globby([path.js.src, '!./src/js/helper/**', '!./src/js/entry/**', '!./src/js/vendor/**']).then(function (entries) {
...
gulp.task('entryScript', () => {
  globby(['./src/js/entry/**', './src/js/vendor/**']).then(function (files) {
    // create the Browserify instance.
...
// watch
gulp.task('watch', ['BSync', 'sass', 'script', 'entryScript', 'pug'], function () {
