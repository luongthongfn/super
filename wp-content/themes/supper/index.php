    ...
    <div class="container">
        <div class="row m-80">
            <div class="col-lg-3 col-md-3 hidden-sm hidden-xs p80">
                <div class="danhmuc">
                    <h2 class="tit-dm">
                        <div class="tit-icon"><i class="fa fa-bars"></i></div> Danh mục sản phẩm
                    </h2>
                    <ul class="as-menu">
                        <li class="dropdown"><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm1.png">Tất cả sản phẩm</a>
                            <ul class="dropdown-content">
                                <li class="dropdown"><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm-child.png">link 1</a>
                                    <ul class="dropdown-content">
                        ...
                        <li><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm3.png">Mỹ phẩm</a></li>
                        <li><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm4.png"> thời trang</a></li>
                        <li><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm5.png">Điện thoại & ipad</a></li>
                        <li><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm6.png">Mẹ và bé</a></li>
                        <li><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm7.png">phụ kiện công nghệ</a></li>
                        <li><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm8.png">Laptop</a></li>
                        <li><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm9.png">Trang sức</a></li>
                        <li><a href=""><img src="<?php echo THEME_URL ?>/assets/img/i-dm10.png">Máy ảnh</a></li>
