...
<div id="post-<?php the_ID(); ?>" <?php post_class('prod'); ?> >
    <div class="relative">
        ...
        <div class="deal-countdown" data-deal-time="<?= date("Y-m-d H:i:s", get_post_meta(get_the_ID(), '_flashsale_to', true)) ?>">
            <?php
            $metato = get_post_meta(get_the_ID(), '_flashsale_to', true) ;
            echo ("<script>console.log('metato: ','$metato')</script>");
            ?>
